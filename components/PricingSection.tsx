...
const PricingSection = (): JSX.Element => {
    ...
    const enterpriseCardVariants: Variants = {
    ...
    return (
        <section ref={ref}>
            <div className="max-w-7xl mx-auto px-4 py-24 flex flex-col justify-center items-center">
                ...
                <motion.h2 className="mb-0 mt-4 text-4xl md:text-5xl font-bold leading-tight text-center" variants={itemVariants} initial="hidden" animate={inView ? "visible" : "hidden"} transition={{ delay: 0.1 }}>
                    Get a plan that grows with you
                </motion.h2>

                <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center justify-center gap-6 mt-20" variants={containerVariants} initial="hidden" animate={inView ? "visible" : "hidden"}>
                    <motion.div className="flex flex-col items-start justify-start border-0 md:border-r px-[1.875rem]" variants={cardVariants}>
                        <motion.figure initial={{ rotate: -10, scale: 0.8 }} animate={inView ? { rotate: 0, scale: 1 } : {}} transition={{ delay: 0.4, duration: 0.5, type: "spring" }}>
                            <svg width="120px" height="156px" viewBox="0 0 120 156">
                                <path className="fill-[#09b850]" d="M46.8,18.5c-0.3,0-0.6,0.1-0.8,0.2c-0.3,0.1-0.5,0.3-0.7,0.5c-0.2,0.2-0.3,0.5-0.4,0.8 c-0.1,0.3-0.1,0.6-0.1,0.9c0.1,1.3,0.2,2.7,0.2,4c0,0.2,0.1,0.4,0.2,0.6c0.1,0.2,0.2,0.4,0.4,0.5c0.2,0.1,0.4,0.2,0.6,0.3 c0.2,0.1,0.4,0.1,0.6,0.1c3.5-0.2,4.9-1.5,4.8-4.2C51.4,19.4,49.7,18.5,46.8,18.5z"></path>
                                <path className="fill-[#09b850]" d="M47.3,29.7c-0.4,0.1-0.8,0.3-1.1,0.6c-0.3,0.3-0.4,0.7-0.4,1.2c0.1,1.6,0.2,3,0.4,4.6c0,0.2,0.1,0.5,0.2,0.7 c1.6-2.2,3.6-4.2,5.8-5.8C51.4,29.9,49.7,29.4,47.3,29.7z"></path>
                                ...
                                <path className="fill-[#09b850]" d="M74.7,61.3c3.7,0,5.6-1.3,5.8-3.9c0.2-2.7-1.4-4.2-5.5-4.4c-0.4,0-0.9,0.1-1.2,0.5c-0.3,0.3-0.5,0.7-0.5,1.2 c-0.1,1.6-0.2,3.3-0.2,4.8c0,0.2,0,0.5,0,0.7c0.1,0.2,0.2,0.4,0.3,0.6c0.2,0.2,0.4,0.3,0.6,0.4C74.2,61.2,74.4,61.3,74.7,61.3z"></path>
                                 <path className="fill-[#09b850]" d="M75,49.4c3.7,0.2,5.4-0.8,5.5-3.6c0.2-2.9-1.3-4.1-4.4-4.4c-0.3,0-0.6,0-0.9,0.1c-0.3,0.1-0.6,0.2-0.8,0.4 c-0.2,0.2-0.4,0.4-0.6,0.7c-0.1,0.3-0.2,0.6-0.2,0.9c-0.1,1.4-0.2,2.8-0.2,4.1c0,0.2,0,0.5,0.1,0.7c0.1,0.2,0.2,0.4,0.3,0.6 c0.2,0.2,0.3,0.3,0.5,0.4C74.6,49.4,74.8,49.4,75,49.4z"></path>
                                 ...
                                 <path className="fill-[#09b850]" d="M46.8,63.8c-1.8-2.2-3.6-2.1-6.2-0.4c-0.2,0.2-0.5,0.4-0.6,0.7c-0.2,0.3-0.2,0.5-0.3,0.8c0,0.3,0,0.6,0.1,0.9 c0.1,0.3,0.2,0.5,0.4,0.8c0.8,1.1,1.8,2.2,2.6,3.3c0.3,0.4,0.7,0.6,1.2,0.7s0.9,0,1.3-0.3C48.1,67.9,48.6,66.1,46.8,63.8z"></path>
                                 <path className="fill-[#09b850]" d="M54.5,72.4c-1.6-2.1-3.9-2.2-7,0.4c-0.3,0.3-0.6,0.7-0.6,1.2c0,0.5,0.1,0.9,0.4,1.3c0.4,0.5,0.7,0.8,1.1,1.3 c2.3-0.6,4.7-1.3,7.1-1.9C55.4,73.8,55,73,54.5,72.4z"></path>
                    ...
                    {/* Features List */}
                    <motion.div className="flex flex-col items-start justify-start px-[1.875rem]" variants={cardVariants} transition={{ delay: 0.3 }}>
                        <motion.h5 
                        ...
                        >
                            Quality Services only, Guaranteed.
                        </motion.p>
                    </motion.div>

                    <motion.div 
                        className="flex flex-col items-start justify-between py-[1.25rem] px-[1.25rem] bg-[#0B9944] rounded-sm relative sm:w-full"
                        variants={enterpriseCardVariants}
                        transition={{ delay: 0.4 }}
                    >
                        <div className="flex flex-col items-start">
                            <motion.div 
                                className="py-[0.35em] px-[0.65em] text-[0.75em] text-white bg-[#202124] dark:bg-white dark:text-black rounded-md font-bold mt-4 flex items-center justify-center"
                                variants={itemVariants}
                                transition={{ delay: 0.5 }}
                            >
                                Enterprise
                            ...
                            <motion.h4 
                                className="text-white mb-0 mt-3 text-[2rem] font-bold"
                                variants={itemVariants}
                                transition={{ delay: 0.6 }}
                            >
                                Custom pricing plan
                        ...
                        <motion.div 
                            className="flex flex-col items-center justify-center text-center mt-40 w-full"
                            variants={itemVariants}
                            transition={{ delay: 0.7 }}
                        >
                        ...
                        <motion.div 
                            className="absolute top-0 right-0 -ml-80 hidden xl:block opacity-20"
