...
const _CTAHome = () => (
    <div className="bg-[#09b850] text-white py-10 px-3 md:px-5 sm:rounded-sm text-center -mt-48 relative overflow-hidden sm:mb-20">
        ...
        <div className="flex flex-col md:flex-row sm:justify-between sm:items-center w-full">
            <div className="w-full flex flex-col justify-start sm:justify-center items-start text-start gap-6">
            ...
            <div className="md:mt-0 w-full flex flex-col justify-center mt-5 sm:mt-2 z-50">
                <ul className="flex flex-col gap-2 justify-start items-start sm:items-end">
                    ...
                    <li><Link href={`mailto:${AppSettings.CompanyContacts.Email}`} className="flex items-center font-semibold"><MdOutlineMail className="mr-2"/> Email at: {AppSettings.CompanyContacts.Email}</Link></li>
                </ul>
            </div>
        </div>
    </div>
