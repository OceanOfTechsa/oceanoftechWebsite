          ...
          <div className="pt-2 md:pt-0 grid grid-cols-1 md:grid-cols-5 gap-3 md:gap-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-1">
                <div className="flex flex-col">
                  <div className="space-y-0.5">
                    <span className="ms-2.5 font-semibold text-xs uppercase">
                      About us
                    </span>
                    <Link
                      className="mt-2 p-2 flex gap-x-3  focus:outline-none  rounded-md hover:bg-[#09b850]/10 hover:text-[#09b850] focus:bg-[#09b850]"
                    ...
                    >
                      ...
                      <div className="grow">
                        <p className="text-sm mb-0">Customer stories</p>
                      </div>
                    </Link>
                    ...
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-bank2 shrink-0 size-4 mt-0.5"
                        viewBox="0 0 16 16"
                      >
                ...
                <div className="flex flex-col">
                  <div className="space-y-0.5">
                    <span className="ms-2.5 mb-2 font-semibold text-xs uppercase">
                      Support
                    </span>
                    <Link
                      className="mt-2 p-2 flex gap-x-3  focus:outline-none  rounded-md hover:bg-[#09b850]/10 hover:text-[#09b850] focus:bg-[#09b850]"
                    ...
                    >
                      ...
                      <div className="grow">
                        <p className="text-sm mb-0">Developer Hub</p>
                      </div>
                    </Link>
                  ...
                  <div className="mt-3 md:mt-7 space-y-0.5">
                    ...
                    >
                      ...
                      <div className="grow">
                        <p className="text-sm mb-0">Become a Partner</p>
                      </div>
                    </Link>
                  </div>
                </div>
            ...
            <div className="md:col-span-2">
              <div className="p-2 md:p-4 md:h-full md:flex-1 flex flex-col md:bg-gray-50 md:rounded-br-lg dark:bg-[#202124] rounded-lg">
                <span className="mb-2 font-semibold text-xs uppercase">
                  Our Blog Posts
                </span>
                <Link
                  className="group flex flex-row items-center md:items-start md:flex-col gap-4 md:gap-2 focus:outline-none group"
                  href="/blog"
                >
                  <Image
                    className="shrink-0 md:w-full size-28 object-cover rounded-lg"
                    src="/menu-blog.jpg"
                    alt="Our blog Image"
                    title="Our blog Image"
                    width={600}
                    height={600}
                    quality={100}
                  ...
                  <div className="grow">
                    <p className="text-sm mb-0">
                      Explore tech insights, tips, and trends to elevate your
                      digital presence and empower your business.
                    </p>
                    <p className="mt-3 inline-flex items-center gap-x-1 text-sm decoration-2 hover:underline group-hover:text-green-500">
                      Start reading
                      <svg
                        className="shrink-0 size-4 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
