            ...
            <div className="max-w-7xl mx-auto px-4 md:px-0 mt-5 py-24 mb-32">
                ...
                >
                    ...
                    >
                        ...
                        <motion.h2 
                            className="my-4 text-4xl font-bold leading-tight"
                            variants={itemVariants}
                            transition={{ delay: 0.1 }}
                        >
                            See how we&apos;ve helped our <br className="hidden md:block"/>clients succeed
                        </motion.h2>
                        ...
                        >
                            Powering 3+ companies and agencies.
                        </motion.p>
                    ...
                    >
                        <div className="grid grid-col-1 md:grid-col-2 items-start gap-6 pe-0 xl:pe-10">
                            ...
                            >
                                ...
                                />
                                <motion.figure 
                                    className="text-right -mr-3 -mt-5"
