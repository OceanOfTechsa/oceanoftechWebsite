    ...
    return (
        <div className="px-3 sm:p-0">
            <motion.div
                ...
                className="relative rounded-lg border dark:border-card bg-white/10 backdrop-blur p-10 shadow-lg container mx-auto mt-20 my-32"
            >
            <span className="text-green-500 mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 rounded-sm overflow-hidden mt-3">
                    <div className="sm:col-span-5 relative">
                        ...
                        <div className="absolute inset-0 flex flex-col">
                            <ul className="flex gap-3 mb-1 mt-auto mx-auto">
                                ...
                                <li>
                                    <button className="flex items-center justify-center w-12 h-12 rounded-full bg-red-600 text-white shadow">
