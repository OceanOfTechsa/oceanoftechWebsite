...
const GoogleReviewsBanner = () => {
    return (
        <Link className="flex items-center gap-3 group" href="https://g.page/r/CU3CZKX3tetcEBM/review" target="_blank">
            ...
            <div className="mt-2">
                <h6 className="font-semibold text-[#606261] dark:text-[#c4c5c7] group-hover:text-[#0B9944] dark:group-hover:text-[#09b850] transition-colors ease-in-out duration-500">10+ Google reviews</h6>
                <div className="flex items-center gap-2 -mt-2">
                    <span className="text-xs mb-3 text-[#606261] dark:text-[#c4c5c7]">
                        5/5
                    </span>
