                ...
                <div className="grid xl:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="xl:col-span-7 space-y-8 w-full">
                        ...
                        <h1 className="text-4xl md:text-[3.6rem] font-bold leading-tight hidden sm:block w-full">
                            ...
                            <br/>
                            for your
                            <FlipWords className="text-[#0B9944] dark:text-[#09b850]" words={["Brand", "Agency", "Startup", "Corp", "SME"]} />
                        ...
                        <div className="flex flex-col items-start gap-1 md:w-lg">
                            ...
                            <span className="text-xs text-[#606261] dark:text-[#c4c5c7]">💌 Leave us your Email and we will get back to you</span>
                        </div>
                    ...
                    <div className="xl:col-span-5 relative">
                        ...
                        <div className="inline-block bg-[#191b1d] rounded-md absolute bottom-0 start-0 mb-4 p-3 z-10 ml-3 md:-ml-20 ">
                            <div className="flex items-center justify-between">
                                <h6 className="text-[#c4c5c7] mb-0 mr-10 font-bold text-2xl"><CountUp end={10} duration={1}/>+</h6>
                                <ul className="flex items-center -space-x-4">
                                    ...
                                    <li className="relative w-8 h-8 rounded-full ring-2 ring-[#191b1d] bg-white shadow-md hover:z-10 hover:scale-110 transition-all duration-500 ease-n-out">
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="pb-0 mb-0 text-white dark:text-black">Next.JS</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </li>
                                    ...
                                    <li className="relative w-8 h-8 rounded-full ring-2 ring-[#191b1d] bg-white shadow-md hover:z-10 hover:scale-110 transition-all duration-500 ease-n-out">
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="pb-0 mb-0 text-white dark:text-black">TypeScript</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </li>
                                    ...
                                    <li className="relative w-8 h-8 rounded-full ring-2 ring-[#191b1d] bg-white shadow-md hover:z-10 hover:scale-110 transition-all duration-500 ease-n-out">
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="pb-0 mb-0 text-white dark:text-black">Tailwind CSS</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </li>
                                    ...
                                    <li className="relative w-8 h-8 rounded-full ring-2 ring-[#191b1d] bg-white shadow-md hover:z-10 hover:scale-110 transition-all duration-500 ease-n-out">
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="pb-0 mb-0 text-white dark:text-black">PostgreSQL</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </li>
                                    ...
                                    <li className="relative w-8 h-8 rounded-full ring-2 ring-[#191b1d] bg-gradient-to-br from-cyan-500 to-purple-600 shadow-md flex items-center justify-center">
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p className="pb-0 mb-0 text-white dark:text-black">More</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </li>
                                </ul>
                            </div>
                            <p className="text-[#c4c5c7] mt-2 mb-0">Modern Technologies We Use</p>
                        </div>
