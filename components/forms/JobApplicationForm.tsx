...
export default function JobApplicationForm({ job }: JobApplicationFormProps) {
  ...
  const [collapsedEduStates, setCollapsedEduStates] = useState<
    Record<string, boolean>
  >({});
  const [collapsedWorkStates, setCollapsedWorkStates] = useState<
    Record<string, boolean>
  >({});
  ...
  const updateError = (
    field: keyof JobApplicationErrors,
    value: boolean,
  ): void => {
    setErrors((prev: JobApplicationErrors) => ({ ...prev, [field]: value }));
  };

  const resetErrors = (fields: (keyof JobApplicationErrors)[]): void => {
    setErrors((prev: JobApplicationErrors) => {
      const newErrors = { ...prev };
      fields.forEach((field: keyof JobApplicationErrors): void => {
        if (
          field === "educationalBackgroundsError" ||
          field === "workExperiencesError"
        ) {
          const subFields: string[] = Object.keys(newErrors[field] || {});
          const resetObj: { [key: string]: { [field: string]: boolean } } = {};
          subFields.forEach((subField: string): void => {
            resetObj[subField] = Object.keys(
              newErrors[field][subField] || {},
            ).reduce(
              (acc: {}, key: string): {} => ({ ...acc, [key]: false }),
              {},
            );
          });
  ...
  const handleEmailValidation: () => boolean = useCallback((): boolean => {
    const valid: boolean = validateEmail(formData.email);
  ...
  const handleZoomIn: () => void = (): void =>
    setZoomLevel((prev: number): number => Math.min(prev + 25, 200));
  const handleZoomOut: () => void = (): void =>
    setZoomLevel((prev: number): number => Math.max(prev - 25, 50));
  const handleZoomReset: () => void = (): void => setZoomLevel(100);
  ...
  const removeEducationalBackground = (id: string) => {
    if (formData.educationalBackgrounds.length > 1) {
      setFormData((prev) => ({
        ...prev,
        educationalBackgrounds: prev.educationalBackgrounds.filter(
          (edu) => edu.id !== id,
        ),
      }));
      setErrors((prev) => {
    ...
    try {
      ...
      formData.educationalBackgrounds.forEach((edu) => {
        if (edu.academicRecord && uploadedFiles.academicRecords[edu.id]) {
          const fileName =
            uploadedFiles.academicRecords[edu.id].fileName || "Academic Record";
      ...
      if (formData.other) {
        const fileName =
          uploadedFiles.otherDocuments.fileName || "Supporting Document";
      ...
      const data = {
        ...
        educationalBackgrounds: formData.educationalBackgrounds.map(
          ({ ...rest }) => rest,
        ),
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8 w-full">
      ...
      <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
        <DialogContent className="max-w-6xl min-w-[220px] md:min-w-[900px] max-h-[85vh] overflow-hidden w-full bg-white dark:bg-[#202124] rounded-md shadow-md pb-6 mx-4">
            ...
            <DialogTitle className="flex items-center justify-between px-6">
              <div className="flex items-center gap-3">
                ...
                >
                  {(() => {
                    ...
                    const extension = previewDocument.name
                      .split(".")
                      .pop()
                      ?.toLowerCase();
                    ...
                    return (
                      previewDocument?.type.split("/")[1]?.toUpperCase() ||
                      "UNKNOWN"
                    );
                  })()}
                </Badge>
              ...
              <div className="flex items-center gap-3">
                {previewDocument?.type.includes("pdf") && (
                  <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg p-2 shadow-sm">
                    <Button
                      size="sm"
                      variant="ghost"
                    ...
                    <span className="text-sm px-3 text-gray-700 dark:text-gray-200 min-w-[70px] text-center">
                      {zoomLevel}%
                    </span>
                    <Button
                      size="sm"
          ...
          <div className="flex-1 overflow-auto p-6 w-full">
            {previewDocument?.type.includes("pdf") ? (
              ...
              <div className="flex flex-col items-center justify-center h-[90vh] border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-800">
            ...
            const isCurrentStepComplete = () => {
              ...
              switch (step) {
                ...
                case 2: // Step 2: Educational Background
                  isComplete = formData.educationalBackgrounds.every(
                    (edu) =>
                ...
                case 3: // Step 3: Work Experience
                  isComplete = formData.workExperiences.every(
                    (work) =>
                      !!work.job_title &&
                      !!work.company &&
            ...
            const isPreviousStepValid = () => {
              ...
              switch (stepNumber) {
                ...
                case 3: // Check Step 1 and Step 2 validation
                  ...
                  isValid =
                    isValid &&
                    formData.educationalBackgrounds.every(
                      (edu) =>
                        !!edu.educational_level &&
                        !!edu.institution &&
                        !!edu.start_date &&
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  ...
                  helps us understand who you are and how to contact you.
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            {submissionError && (
              <Alert variant="destructive" className="mb-6">
                ...
                <AlertDescription>
                  Unable to continue, missing required field(s)
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="flex flex-col gap-2 mb-7">
              <Alert className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                ...
                <AlertDescription className="text-black dark:text-white">
                  Ensure your email is correct as we&apos;ll use it for
                  communication
                </AlertDescription>
              </Alert>
              ...
              <Alert className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto ">
                <Info className="h-2 w-2 -mt-1" />
                <AlertDescription className="text-black dark:text-white flex items-center">
                  Hover over{" "}
                  <HelpCircle className="mx-1 h-5 w-5 cursor-help" size={18} />{" "}
                  to get more help
                </AlertDescription>
              </Alert>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <HelpCircle className="mx-1 h-4 w-4 text-muted-foreground cursor-help" />
                      </TooltipTrigger>
                      <TooltipContent>
                        <p className="text-white dark:text-black mb-0">
                          Please provide your first name and, if you have a
                          second name, include it as shown on your official
                          documents.
                        </p>
                      </TooltipContent>
                    </Tooltip>
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Provide a valid email address for communication (e.g.,
                        example@email.com).
                      </p>
                      <p className="text-white dark:text-black mb-0">
                        The provided email will be used for communications.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </Label>
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Enter your contact number (e.g., 0823 456 789) with no
                        letters.
                      </p>
                    </TooltipContent>
                  </Tooltip>
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Select your date of birth in YYYY-MM-DD format.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </Label>
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Optional: Add a link to your portfolio or GitHub
                        profile.
                      </p>
                    </TooltipContent>
                  </Tooltip>
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Write a brief introduction about yourself (e.g., skills,
                        experience, or goals)
                      </p>
                    </TooltipContent>
                  </Tooltip>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Tell us about your educational qualifications and academic
                  achievements.
                </p>
              </div>
            </div>
          ...
          <CardContent>
            <div className="flex flex-col gap-2">
              <Alert className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                ...
                <AlertDescription className="text-black dark:text-white">
                  {" "}
                  Upload clear, readable academic documents. Include all
            ...
            >
              {formData.educationalBackgrounds.map(
                (edu: EducationalBackground, index: number) => {
                  const isCollapsed: boolean =
                    collapsedEduStates[edu.id] || false;
                  return (
                    <Card
                      key={edu.id}
                    ...
                    >
                      <CardHeader
                        className="py-0 cursor-pointer flex items-center w-full justify-between"
                        onClick={() =>
                          setCollapsedEduStates((prev) => ({
                            ...prev,
                            [edu.id]: !isCollapsed,
                          }))
                        }
                          ...
                          <div className="flex gap-3 items-center">
                            ...
                            {formData.educationalBackgrounds.length > 1 && (
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  removeEducationalBackground(edu.id)
                                }
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Select or enter your highest level of
                            ...
                            />
                            {errors.educationalBackgroundsError[edu.id]
                              ?.educational_level && (
                              <p className="text-xs text-red-500 mt-1">
                                <AlertTriangle className="inline h-3 w-3 mr-1" />
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Enter the name of the institution where you
                                    studied.
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            ...
                            <div>
                              ...
                              >
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-white dark:text-black mb-0">
                                      Select the start date of your education in
                                      YYYY-MM-DD format.
                                    </p>
                                  </TooltipContent>
                                </Tooltip>
                            ...
                            <div>
                              ...
                              >
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-white dark:text-black mb-0">
                                      Select the end date of your education in
                                      YYYY-MM-DD format (must be after start
                                      date).
                                    </p>
                                  </TooltipContent>
                                </Tooltip>
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Enter the degree or certification obtained
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Enter your field of study (e.g., Software
                                    Engineering).
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                          ...
                          <div>
                            <Label className="mb-1 w-full flex justify-between items-center">
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Upload a PDF, DOC, or DOCX file of your
                            ...
                            {individualUploadProgress[`academic-${edu.id}`] >
                              0 &&
                              individualUploadProgress[`academic-${edu.id}`] <
                                100 && (
                                <div className="mb-2">
                            ...
                            >
                              ...
                              {uploadedFiles.academicRecords[edu.id]
                                ?.uploaded && (
                                ...
                                <div className="flex justify-between items-center">
                                  ...
                                  <div className="space-x-2">
                                    ...
                                    <Button
                                      ...
                                      onClick={() =>
                                        handleRemoveAcademicRecord(edu.id)
                                      }
                                    >
            ...
            >
              {formData.workExperiences.map(
                (work: WorkExperience, index: number) => {
                  const isCollapsed: boolean =
                    collapsedWorkStates[work.id] || false;
                  return (
                    <Card
                      key={work.id}
                      className="bg-transparent border rounded-sm shadow-none py-2 transition-all duration-500 ease-in-out"
                    >
                      ...
                      {!isCollapsed && (
                        <CardContent className="space-y-6">
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Enter the title of the job you held (e.g.,
                                    Software Developer).
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            ...
                            />
                            {errors.workExperiencesError[work.id]
                              ?.job_title && (
                              <p className="text-xs text-red-500 mt-1">
                                <AlertTriangle className="inline h-3 w-3 mr-1" />
                          ...
                          <div>
                            ...
                            >
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Enter the name of the company where you
                                    worked.
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            ...
                            <Input
                              id={`company-${work.id}`}
                              value={work.company}
                              placeholder={AppSettings.COMPANY_NAME}
                              onChange={(e): void =>
                                updateWorkExperience(
                                  work.id,
                                  "company",
                            ...
                            <div>
                              ...
                              >
                                ...
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="text-white dark:text-black mb-0">
                                      Select the end date of your employment in
                                      YYYY-MM-DD format (must be after start
                                      date).
                                    </p>
                                  </TooltipContent>
                          ...
                          <div>
                            <Label
                              htmlFor={`responsibilities-${work.id}`}
                              className="mb-1 w-full flex justify-between items-center"
                            >
                              <span>
                                Responsibilities{" "}
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p className="text-white dark:text-black mb-0">
                                    Describe your key responsibilities in this
                                    role (e.g., developed web applications).
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </Label>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Upload your resume, cover letter, and any other supporting
                  documents that showcase your qualifications.
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-2">
              <Alert className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                <Info className="h-2 w-2 -mt-1" />
                <AlertDescription className="text-black dark:text-white">
                  Ensure documents are in PDF, DOC, or DOCX format.
                </AlertDescription>
              </Alert>
              <Alert className=" flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                <Info className="h-2 w-2 -mt-1" />
              ...
              <Alert className=" flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                <Info className="h-2 w-2 -mt-1" />
                <AlertDescription className="text-black dark:text-white">
                  Upload clear, readable academic documents.
                </AlertDescription>
              </Alert>
              <Alert className=" flex items-center gap-1 text-xs text-blue-600 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-2 rounded-sm w-auto">
                <Info className="h-2 w-2 -mt-1" />
                <AlertDescription className="text-black dark:text-white">
                  Merge other supporting document into one document
                </AlertDescription>
              </Alert>
            ...
            <div className="space-y-6 mt-10">
              ...
              <div>
                ...
                {/* Upload progress indicator */}
                {individualUploadProgress.resume > 0 &&
                  individualUploadProgress.resume < 100 && (
                    <div className="mb-2">
                      <div className="flex justify-between text-xs text-muted-foreground mb-1">
                      ...
                      <Progress
                        value={individualUploadProgress.resume}
                        className="h-1"
                      />
                    </div>
                  )}
              ...
              <div>
                ...
                {/* Upload progress indicator */}
                {individualUploadProgress.coverLetter > 0 &&
                  individualUploadProgress.coverLetter < 100 && (
                    <div className="mb-2">
                      <div className="flex justify-between text-xs text-muted-foreground mb-1">
                      ...
                      <Progress
                        value={individualUploadProgress.coverLetter}
                        className="h-1"
                      />
                    </div>
                  )}
              ...
              <div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-white dark:text-black mb-0">
                        Please upload any supporting documents in PDF, DOC, or
                        DOCX format. For best results, use PDF.
                      </p>
                      <p className="text-white dark:text-black mb-0">
                        If you have several files, consider merging them into a
                        single PDF before uploading
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </Label>
                ...
                {/* Upload progress indicator */}
                {individualUploadProgress.otherDocuments > 0 &&
                  individualUploadProgress.otherDocuments < 100 && (
                    <div className="mb-2">
                      <div className="flex justify-between text-xs text-muted-foreground mb-1">
                      ...
                      <Progress
                        value={individualUploadProgress.otherDocuments}
                        className="h-1"
                      />
                    </div>
                  )}
      ...
      {step === 5 && (
        <Card className="bg-transparent rounded-md border shadow-none">
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Review all your information carefully before submitting. You
                  can edit any section by clicking on the respective fields.
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-8">
            ...
            {formData.educationalBackgrounds.map(
              (educationalHistory, index: number) => (
                <div key={educationalHistory.id}>
                  <h3 className="text-xl font-semibold mb-4">
                    {index + 1}. Educational details
                  </h3>
                  <div className="space-y-6">
                    <div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="text-xs text-muted-foreground">
                          You&apos;ll be redirected to the Educational History
                          step. Use the top navigation to come back. or use the
                          continue button
                        </span>
                      </Button>
                      {uploadedFiles.academicRecords[educationalHistory.id]
                        ?.uploaded && (
                        <div className="flex justify-between items-center mt-2">
                          <span className="text-sm text-muted-foreground">
                            {
                              uploadedFiles.academicRecords[
                                educationalHistory.id
                              ].fileName
                            }
                          </span>
            ...
            <div className="flex items-center mt-6">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  updateFormData("agree", checked as boolean)
                }
              ...
              >
                I, {formData.name} {formData.surname}, hereby declare that the
                information provided is true and may be used for evaluation
        ...
        <div className="space-y-6">
          <Card className="bg-transparent rounded-md border shadow-none">
            <CardContent className="text-center py-12">
              <div className="w-20 h-20 rounded-full bg-green-100 dark:bg-green-900 p-4 flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                ...
                position. We have received your application and will review it
                shortly.
              </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm">
                        If shortlisted, we&apos;ll contact you via email for the
                        next steps
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm">
                        Keep an eye on your email and check your application
                        status using the tracking link
                      </p>
                    </div>
                  </div>
                </CardContent>
