...
export const metadata: Metadata = {
  title: "Our Team",
  description: `Meet the talented developers, designers, and innovators behind ${AppSettings.COMPANY_NAME}. Our team is driven by passion, collaboration, and cutting-edge technology.`,
  keywords: [
    "our team",
    "meet the team",
  ...
  openGraph: {
    title: `Our Team | ${AppSettings.COMPANY_NAME}`,
    description: `Get to know the people powering ${AppSettings.COMPANY_NAME} — a team of skilled professionals building impactful digital solutions.`,
    url: `https://${AppSettings.COMPANY_DOMAIN}/team`,
    siteName: `${AppSettings.COMPANY_NAME}`,
    images: [
      {
        url: `https://${AppSettings.COMPANY_DOMAIN}/og-team.png`,
        width: 1200,
        height: 630,
        alt: `Meet the ${AppSettings.COMPANY_NAME} Team`,
      },
    ],
    locale: "en_ZA",
    type: "website",
  ...
  twitter: {
    ...
    title: `Our Team | ${AppSettings.COMPANY_NAME}`,
    description: `Meet the talented team behind ${AppSettings.COMPANY_NAME} — passionate professionals delivering modern digital solutions.`,
    images: [`https://${AppSettings.COMPANY_DOMAIN}/og-team.png`],
  },
  ...
  alternates: {
    canonical: `https://$${AppSettings.COMPANY_DOMAIN}/team`,
  },
};
    ...
    <div className="w-full flex flex-col">
      <section className="w-full mx-auto pt-6 px-4  md:px-0 overflow-hidden">
        <div className="mx-auto">
          <div
            className="relative md:h-[400px] xl:h-[500px] bg-center bg-cover  overflow-hidden bg-fixed"
              ...
              (member: TeamMember, index: number): JSX.Element => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-sm">
                    {member.img !== "" ? (
                      <div className="relative h-[405px] w-[275px] rounded-sm overflow-hidden">
                        <Image
                          src={member.img}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-0 divide-x">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 xl:gap-16">
            <div className="lg:col-span-6 w-full">
              <h2 className="text-[56.96px] md:text-[2.75rem] font-[700] mb-[1rem] leading-tight">
                Our Lifetime Achievements
              </h2>
              <p className="mb-4 text-[#606261] dark:text-[#c4c5c7] font-normal">
                At {AppSettings.COMPANY_NAME}, we prioritize excellence,
                industry compliance, and continuous professional development.
                Our team's certifications reflect a commitment to delivering
                reliable, future-focused, and high-quality technology solutions.
              </p>
              <div className="bg-[#F8F8F8] dark:bg-[#202124] px-[1.5rem] py-[1rem] rounded-sm inline-block mt-6 font-normal border">
                <span>Work with us?</span>
                <Link
                  href="/contact"
                  className="text-[#0B9944] hover:text-[#0B9944]/80 ml-2 inline-flex items-center transition-all duration-500 ease-in-out"
                >
                  Contact us now{" "}
            ...
            <div className="lg:col-span-6 w-full">
              <div className="grid  gap-6 md:gap-8">
                <div className="w-full">
                  <h5 className="text-[26.16px] md:text-[1.5rem] font-[700] mb-3">
                    Team Certifications
                  </h5>
                  <p className="text-sm mb-4 text-[#606261] dark:text-[#c4c5c7]">
                    Professionally attained by individual team members and
                    contributing directly to the capability and credibility of
                    {AppSettings.COMPANY_NAME}.
                  </p>
                  <ul className="space-y-2 text-gray-900">
                    <li className="border-b pb-2 text-[#606261] dark:text-[#c4c5c7] mb-2">
                      <Link
                        href="https://www.credly.com/badges/1619b837-1bbc-40ad-ac66-693d56a701a6/public_url"
                        target="_blank"
                        className="inline-flex items-center gap-2 hover:text-[#09b850] transition-colors ease-in-out duration-400"
                      >
                        <Image
                    ...
                    <li className="border-b pb-2 text-[#606261] dark:text-[#c4c5c7] mb-2">
                      <Link
                        href="https://www.credly.com/badges/fbfd222e-7d33-41a5-b790-4d121731f3e5/public_url"
                        target="_blank"
                        className="inline-flex items-center gap-2 hover:text-[#09b850] transition-colors ease-in-out duration-400"
                      >
                        <Image
                          src="/certificates/getting-started-with-threat-intelligence-and-hunting.png"
                          className="rounded-sm h-10 w-10"
                          alt="certificate-badge"
                          width={100}
                          height={100}
                    ...
                    <li className="border-b pb-2 text-[#606261] dark:text-[#c4c5c7] mb-2">
                      <Link
                        href="/documents/Azure-Fundamentals.pdf"
                        target="_blank"
                        className="inline-flex items-center gap-2 hover:text-[#09b850] transition-colors ease-in-out duration-400"
                      >
                        <Image
                ...
                <div className="hidden">
                  ...
                  <p className="text-sm text-[#606261] dark:text-[#c4c5c7] italic">
                    {AppSettings.COMPANY_NAME} is actively building a portfolio
                    designed to meet and exceed industry benchmarks. While no
                    formal awards have been issued yet, our trajectory, customer
                    satisfaction, and project performance position us strongly
                    for upcoming recognitions and industry distinctions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Accordion type="single" collapsible defaultValue="item-1">
            <AccordionItem value="item-1" className="border-none">
              ...
              <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                ...
                developers, UI/UX designers, project managers, and QA engineers
                dedicated to building scalable and secure custom software
                solutions. Each team member brings specialized technical
                expertise to ensure high-performance web and mobile
                applications.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="border-none">
              ...
              <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                Our development team specializes in modern technologies such as
                React, Next.js, Node.js, TypeScript, cloud computing platforms,
                and API integrations. We continuously adopt the latest software
                development tools and frameworks to deliver reliable,
            ...
            <AccordionItem value="item-3" className="border-none">
              ...
              <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                Our software engineers have extensive experience delivering
                enterprise-grade applications, SaaS platforms, eCommerce
                systems, and custom business software. With proven expertise
                across multiple industries, our team ensures efficient,
            ...
            <AccordionItem value="item-4" className="border-none">
              ...
              <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                ...
                transparency, flexibility, and faster delivery. Our team
                collaborates closely with clients through sprint planning,
                regular updates, and performance tracking to guarantee project
                success.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5" className="border-none">
              ...
              <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                Yes, we offer dedicated development teams tailored to your
                project requirements. Whether you need full-cycle software
                development, product design, or ongoing technical support, our
                dedicated team model ensures focused execution and long-term
                success.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
