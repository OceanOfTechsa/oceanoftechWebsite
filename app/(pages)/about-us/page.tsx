...
import {ArrowRight, Headphones, MapPin, MoveRight} from "lucide-react";
import TestimonialsSection from "@/components/testc";
import {
    Accordion,
    AccordionContent,
    AccordionItem,
    ...
    return(
        <div className="flex flex-col w-full">
                ...
                <div className="w-full flex flex-col items-center justify-center">
                    <nav className="mb-3" aria-label="breadcrumb">
                        <ol className="flex items-center gap-2 pt-0">
                            ...
                            <li className="text-[#0B9944] dark:text-[#09b850]" aria-current="page">About us</li>
                        </ol>
                    </nav>
                    <span className="inline-block bg-gray-200 dark:bg-[#292a2d] text-[#606261] dark:text-[#c4c5c7] text-sm rounded-sm font-semibold px-3 py-1 mt-3 lg:mt-5">
                          <AnimatedIcon icon="🤩"/>  What Drives Us
                    </span>

                    <h1 className="text-4xl md:text-5xl font-bold leading-tight  text-center max-w-3xl mt-3">
                        Driven by Innovation, Defined by  <FlipWords className="text-[#0B9944] dark:text-[#09b850]" words={["Reliability", "Scalability", "Security", "Compliance", "Performance", "Stability"]} />
                    </h1>
            ...
            <section className="mt-5 w-full">
                <div className="w-full flex flex-col sm:flex-row items-center justify-center max-w-5xl mx-auto gap-6 p-4">
                    <div className="flex-col w-full space-y-6 mt-3 sm:mt-0">
                        <div className="relative flex justify-end">
                           ...
                           <div className="absolute top-0 -mt-16 left-0 -ml-5">
                               <svg width="167" height="107" viewBox="0 0 167 107" fill="#09b850"
                                    xmlns="http://www.w3.org/2000/svg">
                                   <path className="fill-[#09b850]" clip-rule="evenodd"
                        ...
                        <div className="hidden sm:flex justify-end relative">
                            <Image
                                src="/16.jpg"
                                width={210}
                                height={210}
                                ...
                                className="object-cover rounded-sm"
                            />
                            <figure className="left-0 ml-56 absolute top-0 ">
                    ...
                    <div className="flex-col w-full space-y-6">
                        <div className="relative">
                            <div className="rounded-sm p-7 bg-[#202124] text-start sm:mt-36 max-w-sm z-50">
                            ...
                            <svg className="opacity-20 absolute right-0 top-0 -mt-[70px] -mr-[20px]" width="148" height="140" viewBox="0 0 148 140"
                                 xmlns="http://www.w3.org/2000/svg">
                                ...
                                <circle className="fill-[#09b850]" cx="25.86" cy="131.41" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="44.71" cy="131.41" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="63.57" cy="131.41" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="82.43" cy="131.41" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="101.29" cy="131.41" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="120.14" cy="131.41" r="2.95"></circle>
                                <path className="fill-[#09b850]"
                                ...
                                <circle className="fill-[#09b850]" cx="25.86" cy="113.61" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="44.71" cy="113.61" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="63.57" cy="113.61" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="82.43" cy="113.61" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="101.29" cy="113.61" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="120.14" cy="113.61" r="2.95"></circle>
                                <path className="fill-[#09b850]"
                                ...
                                <circle className="fill-[#09b850]" cx="25.86" cy="95.81" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="44.71" cy="95.81" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="63.57" cy="95.81" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="82.43" cy="95.81" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="101.29" cy="95.81" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="120.14" cy="95.81" r="2.95"></circle>
                                <path className="fill-[#09b850]"
                                ...
                                <circle className="fill-[#09b850]" cx="25.86" cy="24.62" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="44.71" cy="24.62" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="63.57" cy="24.62" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="82.43" cy="24.62" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="101.29" cy="24.62" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="120.14" cy="24.62" r="2.95"></circle>
                                <path className="fill-[#09b850]"
                                ...
                                <circle className="fill-[#09b850]" cx="25.86" cy="6.82" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="44.71" cy="6.82" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="63.57" cy="6.82" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="82.43" cy="6.82" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="101.29" cy="6.82" r="2.95"></circle>
                                <circle className="fill-[#09b850]" cx="120.14" cy="6.82" r="2.95"></circle>
                                <path className="fill-[#09b850]"
                        ...
                        <div className="w-full relative">
                            ...
                            <Link target="_blank" href="https://www.youtube.com/embed/tXHviS-4ygo" className="absolute bottom-5 right-2 px-3 py-1 text-[#606261] bg-white  rounded-sm inline-flex gap-2 items-center">
                                <Image
                                    src="/YouTube.svg"
                                    width={30}
                                    height={30}
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10">
                        ...
                        <div className="lg:w-1/2">
                            <div className="grid md:grid-cols-2 gap-6 xl:gap-12">
                                ...
                                <div className="space-y-10 sm:mt-10">
                                    ...
                                    {/* Card 2 */}
                                    <div className="bg-[#f8f8f8] dark:bg-[#292a2d] p-6 rounded-sm">
                                        <div className="text-primary mb-4">
                                            <figure className="text-[#0B9944] mb-3 flex-shrink-0">
                                                <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="bg-[#f8f8f8] dark:bg-[#292a2d] p-6 rounded-sm mt-10">
                                        ...
                                        <p>
                                            We believe that the best results are born from the synergy of diverse teams.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-1/2 lg:pl-16">
                            <h2 className="text-3xl md:text-4xl font-bold leading-tight max-w-3xl mb-6">
                                Know About {AppSettings.COMPANY_NAME}
                            </h2>

                            <p className=" mb-4">
                                At {AppSettings.COMPANY_NAME}, we're not just in the business of digital solutions;
                                we're in the business of crafting digital success stories.
                                Founded on a passion for innovation and a commitment to excellence,
                                we've been at the forefront of the digital landscape.
                            </p>
                            ...
                            <p className=" mb-6">
                                ...
                                the digital realm offers boundless opportunities for growth and
                                connection.
                            </p>

                            <div className="flex items-center gap-6">
                                <Link href="/services" className=" bg-[#202124] hover:bg-[#3c3e41] text-white px-[1rem] py-[0.6rem] rounded-[0.2rem] inline-flex font-semibold items-center transition-all duration-500 ease-in-out">
                                    Explore Services!
                                </Link>

                                <Link href="/contact" className="flex items-center gap-2 text-[#0B9944] font-medium hover:gap-3 transition-all group">
                                    Request a quote
                                    <MoveRight className="group-hover:text-[#09b850] group-hover:translate-x-1 transition duration-500 ease-in-out" />
                                </Link>
                            </div>
                        </div>
                    </div>
                ...
                >
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold mb-6">
                            Built in South Africa. Delivering Worldwide.
                        </h2>
                        <p className="text-[#606261] dark:text-[#c4c5c7] mb-10 leading-relaxed">
                            {AppSettings.COMPANY_NAME} designs and develops modern software solutions for businesses across industries. From local startups to international partners, we help organizations transform ideas into powerful digital products.
                        </p>

                        <div className="flex gap-8 text-left justify-center">
                            {/* South Africa Card */}
                            <div className="bg-white dark:bg-neutral-900 border rounded-sm p-6">
                                <div className="mb-6">
                                    <div className="relative w-16 h-16 rounded-full overflow-hidden">
                                        <Image
                                            src="/SouthAfricaFlag.svg"
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid md:grid-cols-12 gap-10">
                        ...
                        <div className="md:col-span-5">
                            <h2 className="text-3xl md:text-4xl max-w-lg font-bold mb-6">
                        ...
                        <div className="md:col-span-7">
                            <Accordion type="single" collapsible defaultValue="item-1">
                                ...
                                <AccordionItem value="item-2" className="border-none">
                                    ...
                                    <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                                        Yes. We partner with early-stage startups looking to build MVPs, as well as established enterprises requiring scalable, secure, and high-performance systems. Whether you're validating an idea or modernizing legacy infrastructure, we tailor our approach to your growth stage.
                                    </AccordionContent>
                                </AccordionItem>

                                <AccordionItem value="item-3" className="border-none">
                                    <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                                        How do you ensure software quality, scalability, and security?
                                    </AccordionTrigger>
                                    <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                                        We follow modern development best practices including clean architecture, code reviews, version control, automated testing, and secure deployment pipelines. Our solutions are built to scale, ensuring long-term reliability for growing businesses in South Africa and global markets.
                                    </AccordionContent>
                                </AccordionItem>

                                <AccordionItem value="item-4" className="border-none">
                                    <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                                        Can {AppSettings.COMPANY_NAME} work with clients outside South Africa?
                                    </AccordionTrigger>
                                    <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                                ...
                                <AccordionItem value="item-5" className="border-none">
                                    <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                                        What makes {AppSettings.COMPANY_NAME} different from other software companies?
                                    </AccordionTrigger>
                                    <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                                        We focus on building strategic technology solutions not just software. Our team prioritizes performance, scalability, business alignment, and measurable results. We aim to become long-term technology partners, not just service providers.
                                    </AccordionContent>
                                </AccordionItem>

                                <AccordionItem value="item-6" className="border-none">
                                    <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                                        How do we get started with {AppSettings.COMPANY_NAME}?
                                    </AccordionTrigger>
                                    <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                                        Getting started is simple. <Link href="/contact" className="underline hover:text-black dark:hover:text-white">Contact us</Link> for a consultation, and we’ll discuss your business goals, technical requirements, timeline, and budget. From there, we propose a tailored roadmap to bring your idea or system to life.
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </div>
            ...
            <section className="bg-[#202124] text-white p-6 w-full -mb-5">
                <div className="border-b border-gray-300/20 max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-center">
                        {/* Left Content */}
                        <div className="md:col-span-6">
                            <h2 className="text-3xl md:text-[42px] font-semibold leading-relaxed text-white max-w-[530px]">
                                Get started on your path to{" "}
                                <span className="relative z-10 inline-block">
                                    success
                                    {/* SVG Highlight */}
                                    <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 hidden lg:block">
                                      <svg
                                          width="188"
                                          height="53"
                                          viewBox="0 0 188 53"
                        ...
                        <div className="md:col-span-6 md:text-right">
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-2 text-[#09b850] bg-[#09b850]/10 hover:bg-[#09b850] hover:text-white transition-all duration-300 px-6 py-3 rounded-[0.2rem] text-lg font-medium group"
                            >
                                Start Your Journey
