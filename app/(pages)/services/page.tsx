                    ...
                    <div className="grid xl:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="xl:col-span-7 space-y-8 w-full">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold leading-tight hidden sm:block">
                                Discover the {" "}
                                <span className="text-[#0B9944] dark:text-[#09b850]">Services</span>
                                <br/>
                                We offer
                            </h1>
                            ...
                            <Link href="/contact" className="bg-[#202124] hover:bg-[#3c3e41] text-white px-[1.2rem] py-[0.8rem] rounded-sm inline-flex gap-2 transition-all duration-500 ease-in-out items-center group">
                                <svg
                            ...
                            <div className="flex items-center justify-normal gap-3 text-start">
                                <ul className="flex items-center mb-0">
                                    <li className="w-17 h-17 rounded-full overflow-hidden">
                                        <Image
                                            src={AppSettings.Reviews[4].avatar}
                                    ...
                                    <li className="w-17 h-17 rounded-full overflow-hidden -ml-2">
                                        <Image
                                            src={AppSettings.Reviews[5].avatar}
                                            className="w-full h-full object-cover"
                                            width={200}
                                            height={200}
                                            quality={100}
                                ...
                                <div className="flex flex-col items-start justify-center text-start">
                                    <h6 className="font-bold text-[#606261] dark:text-[#c4c5c7]  hidden sm:block">Join 3+ Thriving Businesses! <AnimatedIcon icon="🤩" /></h6>
                                    <Link href="/contact"
                ...
                <Accordion type="single" collapsible defaultValue="item-1">
                    <AccordionItem value="item-1" className="border-none">
                        <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                            What software development services does {AppSettings.COMPANY_NAME} provide?
                        </AccordionTrigger>
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            We provide <Link href="/services/web-development" className="underline hover:text-black dark:hover:text-white">Custom Web Development</Link>, <Link href="/services/seo" className="underline hover:text-black dark:hover:text-white">Search Engine Optimisation</Link>, <Link href="/services/hosting" className="underline hover:text-black dark:hover:text-white">Web Hosting</Link>, <Link href="/services/business-emails" className="underline hover:text-black dark:hover:text-white">Email Hosting</Link>, <Link href="/services/software-development" className="underline hover:text-black dark:hover:text-white">business systems</Link>, Enterprise Software Solutions, and more. Our services are tailored for Startups, SMEs, and established businesses in South Africa and internationally.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-2" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            The cost depends on the scope, complexity, features, and timeline of your project. We offer flexible pricing models based on your business needs, whether you're building an MVP or a large-scale enterprise system. <Link href="/contact" className="underline hover:text-black dark:hover:text-white">Contact us</Link> for a tailored quote.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-3" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            Project timelines vary depending on requirements. A standard business website may take a few weeks, while custom applications or SaaS platforms may take several months. We provide a clear roadmap and timeline before development begins.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            Yes. We design and develop secure, high-performance systems built with scalability in mind. Our architecture supports business growth, increased user traffic, and long-term expansion.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-5" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            Absolutely. We help businesses modernize outdated systems, improve performance, enhance UI/UX, and migrate to modern technologies without disrupting operations.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-6" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                          Yes. We provide continuous maintenance, performance optimization, security updates, and technical support to ensure your software runs smoothly after launch. <Link href="/maintenance-support" className="underline hover:text-black dark:hover:text-white">Read More</Link>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-7" className="border-none">
                        ...
                        <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                            Simply <Link href="/contact" className="underline hover:text-black dark:hover:text-white">Contact Us</Link> for a consultation. We’ll discuss your goals, technical requirements, timeline, and budget, then provide a clear development strategy tailored to your business. You can also check <Link href="/services" className="underline hover:text-black dark:hover:text-white">Our Services Here</Link>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </section>
