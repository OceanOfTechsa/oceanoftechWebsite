...
export const metadata: Metadata = {
  ...
  description: `Partner with ${AppSettings.COMPANY_NAME}, a South Africa–based software development company. We collaborate with startups, agencies, and enterprises to build scalable digital solutions.`,
  keywords: [
    "become a partner",
  ...
  openGraph: {
    title: `Become a Partner | ${AppSettings.COMPANY_NAME} South Africa`,
    description: `Looking for a trusted technology partner in South Africa? Partner with ${AppSettings.COMPANY_NAME} to deliver innovative, scalable digital solutions.`,
    url: `https://${AppSettings.COMPANY_DOMAIN}/partners`,
    siteName: `${AppSettings.COMPANY_NAME}`,
    images: [
      {
        url: `https://${AppSettings.COMPANY_DOMAIN}/og-partner.png`,
        width: 1200,
        height: 630,
        alt: `Technology Partnership with ${AppSettings.COMPANY_NAME} South Africa`,
      },
    ],
    locale: "en_ZA",
    type: "website",
  ...
  alternates: {
    canonical: `https://${AppSettings.COMPANY_DOMAIN}/partners`,
  },
};
      ...
      <div className="w-full flex flex-col px-4">
        <section className="w-full mx-auto pt-6 px-4 md:px-0 rounded-sm overflow-hidden">
          <div className="max-w-[70rem] mx-auto">
            <div
              className="relative h-[300px] md:h-[400px] xl:h-[500px] bg-center bg-cover rounded-sm overflow-hidden bg-fixed"
        ...
        <section className="p-6 pt-12 sm:p-12 -mt-32 max-w-[50rem] w-full mx-auto z-20 bg-white dark:bg-[#191b1d] rounded-sm shadow-md mb-32">
          ...
          <div>
            <h1 className="text-[2.38rem] font-font leading-[1.25]">
              Let&apos;s level up your brand{" "}
              <br className="hidden md:inline-flex" /> together.
            </h1>
            <p className="dark:text-[#c4c5c7] mb-10 text-lg">
