...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://${AppSettings.COMPANY_DOMAIN}/careers`,
    siteName: `${AppSettings.COMPANY_NAME}`,
    images: [
      {
        url: `https://${AppSettings.COMPANY_DOMAIN}/og-careers.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`https://${AppSettings.COMPANY_DOMAIN}/og-careers.png`],
  },
  ...
  alternates: {
    canonical: `https://${AppSettings.COMPANY_DOMAIN}/careers`,
  },
};
...
const CareersPage = (): JSX.Element => {
  return (
    <div className="flex flex-col w-full">
      <section className="max-w-5xl mx-auto relative xl:py-20 pb-0 mt-10 sm:mt-0 px-4 sm:px-0 flex flex-col items-center text-center">
        {/* Breadcrumb */}
        ...
        <div className="relative mb-8">
          <figure className="hidden md:block absolute left-0 bottom-0 rotate-12 -ml-72 mt-60 mb-8">
            {" "}
            <svg width="101.6px" height="94.6px" viewBox="0 0 101.6 94.6">
              {" "}
              <path
                className="fill-[#0B9944] dark:fill-green-500"
          ...
          <h1 className="text-[40px] md:text-5xl lg:text-[4rem] font-bold leading-tight">
            Discover exciting career <br className="hidden md:block" />
            <span className="text-[hsl(144,87%,32%)] dark:text-green-500">
              opportunities
            </span>{" "}
            at{" "}
          ...
          <div className="absolute right-0 -mr-40 -mt-6 top-full translate-x-6 translate-y-4 hidden lg:block">
            <div className="relative">
              ...
              <span className="text-lg absolute left-0 top-0 transform -translate-y-4 -translate-x-4 -rotate-90">
                <BsFillCursorFill
                  className="text-[#0B9944] dark:text-green-500"
                  size={25}
                />
              </span>
            </div>
        ...
        <div className="max-w-2xl">
          <p className="text-gray-700 dark:text-gray-300">
            ...
            innovation. Explore exciting career opportunities at Mizzle and be
            part of shaping the digital future.
          </p>
          ...
          <ul className="flex flex-wrap justify-center gap-3 mt-5 text-sm">
            {careers.length > 0 && (
              <li className=" text-[#606261] dark:text-[#c4c5c7]">
                Suggestions:
              </li>
            )}
            {careers?.slice(0, 5).map(
              (sug: Career, i: number): JSX.Element => (
                <li key={i}>
                  <Link
                    href={`/careers/${sug.slug}`}
                    className="hover:text-[#0B9944] hover:dark:text-green-500"
                  >
                    {sug.title},
                  </Link>
                </li>
          ...
          <div className="flex items-center w-full h-full">
            ...
            <div className="ml-3 mt-4">
              <div className="flex items-baseline">
                ...
                <span className="text-[1.5rem] font-bold text-[#0B9944] dark:text-green-500">
                  +
                </span>
              </div>
              <p className="text-[#606261] dark:text-[#c4c5c7] mt-0">
                Total Jobs
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-10">
          ...
          <div className="lg:col-span-7 lg:pl-10 mt-5 lg:mt-0">
            ...
            <p className="text-[#606261] dark:text-[#c4c5c7] mb-8">
              ...
              your quality of life, empowering you to reach new heights in your
              career.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-[#606261] dark:text-[#c4c5c7]">
                  It ensures that users can access critical assistance whenever
                  they need it.
                </p>
              </div>
              ...
              <div>
                ...
                <h6 className="font-bold mt-2 mb-1 text-[1.2rem]">
                  Recognition
                </h6>
                <p className="text-[#606261] dark:text-[#c4c5c7]">
