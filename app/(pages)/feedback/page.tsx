            ...
            <section className="p-6 pt-12 sm:p-12 -mt-32 max-w-[50rem] w-full mx-auto z-20 bg-white dark:bg-[#191b1d] rounded-sm shadow-md mb-32">
                <nav className="mb-3" aria-label="breadcrumb">
                    <ol className="flex items-center gap-2 pt-0">
                        ...
                        <li className="text-[#0B9944] dark:text-[#09b850]" aria-current="page">Feedback</li>
                    </ol>
                </nav>

                <div>
                    <h1 className="text-[2.38rem] font-font leading-[1.25]">We'd love your feedback</h1>
                    <p className="dark:text-[#c4c5c7] mb-10 text-lg">Want to share detailed feedback? Email us anytime at: {" "}
