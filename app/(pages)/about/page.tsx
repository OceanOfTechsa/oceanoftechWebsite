          ...
          <div className="flex-col w-full space-y-6">
            <div className="relative">
              <div className="rounded-sm p-7 bg-[#202124] text-start sm:mt-36 max-w-sm z-50">
                <p className="text-lg max-w-4xl text-white">Our Goal:</p>
              ...
              <svg
                className="opacity-20 absolute right-0 top-0 -mt-[70px] -mr-[20px]"
                width="148"
                height="140"
                viewBox="0 0 148 140"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="w-full relative">
              ...
              <Link
                ...
                className="absolute bottom-5 right-2 px-3 py-1 text-[#606261] bg-white  rounded-sm inline-flex gap-2 items-center"
              >
                <Image
                  src="/YouTube.svg"
                  width={30}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-0">
          <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="grid md:grid-cols-2 gap-6 xl:gap-12">
                ...
                <div className="space-y-10">
                  ...
                  <div className="bg-[#f8f8f8] dark:bg-[#292a2d] p-6 rounded-sm mt-10">
                    ...
                    <p>Celebrate inclusivity with accessible technology.</p>
                  </div>
                  ...
                  <div className="bg-[#f8f8f8] dark:bg-[#292a2d] p-6 rounded-sm mt-10">
                    ...
                    <p>
                      We believe that the best results are born from the synergy
                      of diverse teams.
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:w-1/2 lg:pl-16">
              ...
              <p className=" mb-4">
                At {AppSettings.COMPANY_NAME}, we're not just in the business of
                digital solutions; we're in the business of crafting digital
              ...
              <div className="flex items-center gap-6">
                <Link
                  href="/services"
                  className=" bg-[#202124] hover:bg-[#3c3e41] text-white px-[1rem] py-[0.6rem] rounded-[0.2rem] inline-flex font-semibold items-center transition-all duration-500 ease-in-out"
                >
                  Explore Services!
                </Link>
                ...
                <Link
                  href="/contact"
                  className="flex items-center gap-2 text-[#0B9944] font-medium hover:gap-3 transition-all group"
                >
                  Request a quote
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#606261] dark:text-[#c4c5c7] mb-10 leading-relaxed">
              {AppSettings.COMPANY_NAME} designs and develops modern software
              solutions for businesses across industries. From local startups to
              international partners, we help organizations transform ideas into
              ...
              <Accordion type="single" collapsible defaultValue="item-1">
                <AccordionItem value="item-1" className="border-none">
                  <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                    What services does {AppSettings.COMPANY_NAME} offer in South
                    Africa?
                  </AccordionTrigger>
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    {AppSettings.COMPANY_NAME} is a South Africa-based software
                    ...
                    , enterprise software solutions, and more. We serve
                    startups, SMEs, and established businesses across South
                ...
                <AccordionItem value="item-2" className="border-none">
                  ...
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    Yes. We partner with early-stage startups looking to build
                    MVPs, as well as established enterprises requiring scalable,
                    secure, and high-performance systems. Whether you're
                    validating an idea or modernizing legacy infrastructure, we
                    tailor our approach to your growth stage.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-3" className="border-none">
                  <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                    How do you ensure software quality, scalability, and
                    security?
                  </AccordionTrigger>
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    We follow modern development best practices including clean
                    architecture, code reviews, version control, automated
                    testing, and secure deployment pipelines. Our solutions are
                    built to scale, ensuring long-term reliability for growing
                    businesses in South Africa and global markets.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-4" className="border-none">
                  <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                    Can {AppSettings.COMPANY_NAME} work with clients outside
                    South Africa?
                  </AccordionTrigger>
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    We follow agile software development methodologies to ensure
                    transparency, flexibility, and faster delivery.{" "}
                    <Link
                      href="/team"
                      className="underline hover:text-black dark:hover:text-white"
                    >
                    ...
                    regular updates, and performance tracking to guarantee
                    project success.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-5" className="border-none">
                  <AccordionTrigger className="border h-16 flex items-center py-[4rem] px-[1.25rem] p-3 rounded-sm cursor-pointer font-[600] focus:bg-black focus:text-white dark:focus:bg-white dark:focus:text-black text-lg">
                    What makes {AppSettings.COMPANY_NAME} different from other
                    software companies?
                  </AccordionTrigger>
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    We focus on building strategic technology solutions not just
                    software.{" "}
                    <Link
                      href="/team"
                      className="underline hover:text-black dark:hover:text-white"
                    ...
                    prioritizes performance, scalability, business alignment,
                    and measurable results. We aim to become long-term
                    technology partners, not just service providers.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-6" className="border-none">
                  ...
                  <AccordionContent className="my-[0.5rem] py-[0.2rem] px-[1rem] text-[#606261] dark:text-[#c4c5c7] font-normal text-lg mb-3">
                    ...
                    for a consultation, and we’ll discuss your business goals,
                    technical requirements, timeline, and budget. From there, we
                    propose a tailored roadmap to bring your idea or system to
                    life.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
