...
const AboutPage = (): JSX.Element => {
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="w-full bg-[#202124] mt-24 pb-20">
                <section className="pt-4 -mt-24 max-w-7xl mx-auto">
                    <div className="container mx-auto px-4 md:px-0 pb-20">
                        <div className="flex flex-col md:flex-row items-start justify-start gap-2 md:gap-16 ">
                            <div className="relative bg-[#09b850] text-white rounded-sm p-8 overflow-hidden">
                                <AboutDecoSvg />
                                <div className="relative z-10 h-full mt-28">
                                    <div className="text-4xl text-gray-900 mb-10">
                                        <FaQuoteLeft />
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-0">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div className="relative">                   
                            <figure className="absolute top-0 left-0 -ml-12 -mt-12  z-40">
                                <svg
                                    width="117"
                                    height="98"
                                    viewBox="0 0 117 98"
                                ...
                                >
                                    <path className="fill-black dark:fill-white" d="M53.9804 0.725277C52.9701 1.69222 52.9701 5.07654 53.9804 11.1683C54.9906 17.1634 55.7123 18.5654 57.5885 18.5654C58.3582 18.5654 59.128 18.3237 59.3685 18.0336C59.561 17.6952 59.2723 13.9241 58.7912 9.52449C58.1177 3.52942 57.6847 1.45049 57.0112 0.773624C55.9047 -0.241669 54.9425 -0.290017 53.9804 0.725277Z"></path>
                                    <path className="fill-black dark:fill-white" d="M53.9804 0.725277C52.9701 1.69222 52.9701 5.07654 53.9804 11.1683C54.9906 17.1634 55.7123 18.5654 57.5885 18.5654C58.3582 18.5654 59.128 18.3237 59.3685 18.0336C59.561 17.6952 59.2723 13.9241 58.7912 9.52449C58.1177 3.52942 57.6847 1.45049 57.0112 0.773624C55.9047 -0.241669 54.9425 -0.290017 53.9804 0.725277Z"></path>
                                    <path className="fill-black dark:fill-white" d="M23.2866 15.2294C22.2763 15.8096 22.1801 17.5984 23.046 18.7104C24.1044 20.0641 34.0148 25.9625 35.2656 25.9625C35.891 25.9625 36.7088 25.6241 37.0937 25.2373C38.537 23.4001 36.4202 21.1278 29.1077 16.5348C25.9806 14.6492 24.7779 14.3108 23.2866 15.2294Z"></path>
                                    <path className="fill-black dark:fill-white" d="M23.2866 15.2294C22.2763 15.8096 22.1801 17.5984 23.046 18.7104C24.1044 20.0641 34.0148 25.9625 35.2656 25.9625C35.891 25.9625 36.7088 25.6241 37.0937 25.2373C38.537 23.4001 36.4202 21.1278 29.1077 16.5348C25.9806 14.6492 24.7779 14.3108 23.2866 15.2294Z"></path>
                                    <path className="fill-black dark:fill-white" d="M103.433 40.37L97.8047 41.4337V42.8357C97.8047 43.851 98.1414 44.4312 99.0555 45.0114C100.21 45.6399 101.124 45.6399 107.09 44.8663C116.038 43.7543 116.038 43.7543 116.663 42.3523C117.096 41.337 117.048 40.9985 116.326 40.1283C115.22 38.8713 110.986 38.9196 103.433 40.37Z"></path>
                                    <path className="fill-black dark:fill-white" d="M89.1454 69.9584C88.9529 70.1034 88.8086 70.7803 88.8086 71.4088C88.8086 72.7142 90.2518 73.8262 97.6125 77.9357C103.915 81.465 104.877 81.7551 106.416 80.4981C108.244 79.0477 107.234 77.5006 102.664 74.8898C95.3032 70.6352 90.3 68.7981 89.1454 69.9584Z"></path>
                                    <path className="fill-black dark:fill-white" d="M89.1454 69.9584C88.9529 70.1034 88.8086 70.7803 88.8086 71.4088C88.8086 72.7142 90.2518 73.8262 97.6125 77.9357C103.915 81.465 104.877 81.7551 106.416 80.4981C108.244 79.0477 107.234 77.5006 102.664 74.8898C95.3032 70.6352 90.3 68.7981 89.1454 69.9584Z"></path>
                                    <path className="fill-black dark:fill-white" d="M30.8398 72.8111C28.3382 74.9384 21.2181 86.9769 20.0635 91.038C19.0532 94.519 21.9397 95.9211 24.0565 93.0203C24.6819 92.1984 26.3657 89.2975 27.7609 86.6868C29.1079 84.0277 31.369 80.1115 32.6198 77.8876C34.929 74.0681 35.2177 72.8111 33.9187 71.9408C33.0047 71.3123 32.3312 71.5541 30.8398 72.8111Z"></path>
                                </svg>
                            </figure>
                            <Image
                                src="/14.jpg"
                        ...
                        <div className="lg:pl-12">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                                <ul className="space-y-2">
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge  className="mr-2 text-[#0B9944]" size={19} /> Strategic Call-to-Actions
                                    </li>
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge  className="mr-2 text-[#0B9944]" size={19} /> Content-Rich Sections
                                    </li>
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge  className="mr-2 text-[#0B9944]" size={19} /> Social Media Integration
                                    </li>
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge className="mr-2 text-[#0B9944]" size={19} /> Easy-to-Use Contact Forms
                                    </li>
                                </ul>

                                <ul className="space-y-2">
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge  className="mr-2 text-[#0B9944]" size={19} /> Performance Analytics
                                    </li>
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge className="mr-2 text-[#0B9944]" size={19} /> Fast Loading Speed
                                    </li>
                                    <li className="inline-flex items-center font-semibold dark:text-[#c4c5c7]">
                                        <HiCheckBadge className="mr-2 text-[#0B9944]" size={19} /> Tested on Major Browsers
                                    </li>
                                </ul>
                            </div>
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-6 md:px-0">
                    <div className="bg-[#202124] text-white rounded-sm relative overflow-hidden p-5 md:p-[4rem]">
                        <figure className="absolute bottom-0 left-0 -mb-5 -ml-7">
                            <svg className="fill-white" width="177" height="187" viewBox="0 0 177 187" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative flex flex-col lg:flex-row">
                            <div className="lg:w-5/12 relative order-1">
                                <div className="border border-gray-300/30 rounded-full flex flex-col items-center justify-center h-64 w-64">
                                    <div className="flex">
                                        <h4 className="text-white mb-0 text-4xl">600</h4>
                                        <span className="text-4xl text-[#0B9944] mb-0">+</span>
                                    </div>
                                    <p className="text-[#c4c5c7] mb-0">Happy Customers</p>
                                </div>               
                    
                                <div className="flex justify-end -mt-6 lg:mt-7 xl:-mt-7 -mr-3">
                                    <div className="bg-[#292a2d] rounded-full flex flex-col items-center justify-center h-52 w-52">
                                        <div className="flex justify-center">
                                            <h4 className="mb-0 text-4xl text-white">25</h4>
                                            <span className="text-4xl text-[#0B9944] mb-0">+</span>
                                        </div>
                                        <p className="text-[#c4c5c7] mb-0">Completed Projects</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-center -mt-6 lg:mt-0">
                                    <div className="relative h-60 w-60">
                                        {/* Outer ping ring */}
                                        <div className="absolute inset-0 rounded-full bg-[#0B9944] opacity-20 animate-ping-slow"></div>

                                        {/* Middle ping ring */}
                                        <div className="absolute inset-0 rounded-full bg-[#0B9944] opacity-30 animate-ping-slower"></div>

                                        {/* Main content circle */}
                                        <div className="relative bg-[#0B9944] bg-opacity-10 rounded-full flex flex-col items-center justify-center h-full w-full border-2 border-[#0B9944] border-opacity-50">
                                            <div className="flex justify-center">
                                                <h4 className="mb-0 text-5xl text-white">200</h4>
                                                <span className="text-5xl text-white mb-0">+</span>
                                            </div>
                                            <p className="text-center text-white mb-0 mt-2 text-lg">Acquired Users</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    
                            <div className="lg:w-6/12 lg:ml-auto mb-12 lg:mb-0 order-2">
                                <h3 className="text-4xl md:text-5xl font-bold leading-tight mb-5 text-white">Shaping Digital Futures</h3>
                                <p className="mb-5 text-[#c4c5c7]">
                                    At Ocean of tech, our vision is to pioneer a new era of software solutions. We believe in empowering innovation, enabling businesses to shape their digital futures, and creating a world where software knows no bounds.
                                </p>
                            
                                <div className="flex flex-col sm:flex-row my-10">
                                    <figure className="text-[#0B9944] mb-2">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.24609 17.2586V14.6904H14.7461V17.2586C14.7461 19.1706 14.7461 20.1266 14.5249 20.557C14.0158 21.5475 12.7956 21.9314 11.8111 21.4107C11.3833 21.1845 10.836 20.4007 9.74136 18.833L9.74136 18.833C9.60764 18.6415 9.54079 18.5457 9.48641 18.4451C9.36533 18.2209 9.2882 17.9757 9.25914 17.7226C9.24609 17.609 9.24609 17.4922 9.24609 17.2586Z" fill="currentColor"></path>
                                            <path d="M17.5114 9.84101C19.375 6.88684 20.3067 5.40976 19.9484 4.21191C19.8359 3.83574 19.6441 3.48802 19.386 3.19214C18.5641 2.25 16.8176 2.25 13.3248 2.25H10.6405C7.12482 2.25 5.36697 2.25 4.54466 3.1974C4.28652 3.49482 4.09526 3.84421 3.98384 4.22194C3.6289 5.42518 4.57619 6.90596 6.47077 9.86751L9.23438 14.1875H14.7695L17.5114 9.84101Z" fill="currentColor" fillOpacity="0.25"></path>
                                        </svg>
                                    </figure>
                                
                                    <div className="sm:ml-4">
                                        <h6 className="text-lg font-bold text-white">Innovative Solutions</h6>
                                        <p className="pb-0 text-[#c4c5c7]">We pride ourselves on crafting innovative software solutions that address real-world challenges and drive digital transformation.</p>
                                    </div>
                                </div>                
                                ...
                                <div className="flex flex-col sm:flex-row my-10">
                                    <figure className="text-[#0B9944] mb-2">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 2.5C9.79086 2.5 8 4.41878 8 6.78571C8 6.97115 8.01099 7.15383 8.03232 7.33306C8.28317 9.44152 11 10 12 10C13 10 15.7168 9.44152 15.9677 7.33306C15.989 7.15383 16 6.97115 16 6.78571C16 4.41878 14.2091 2.5 12 2.5Z" fill="currentColor"></path>
                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.24989 7.1053C7.24989 7.05966 7.2505 7.01416 7.25173 6.96883C4.2677 7.95454 2.25 9.97184 2.25 12.1034C2.25 14.0748 3.97605 15.8116 6.59627 16.8293L4.46793 18.9716C4.176 19.2655 4.17756 19.7403 4.47141 20.0323C4.76526 20.3242 5.24013 20.3226 5.53207 20.0288L8.20833 17.3349C9.15517 17.5678 10.1784 17.7162 11.25 17.7636V21C11.25 21.4142 11.5858 21.75 12 21.75C12.4142 21.75 12.75 21.4142 12.75 21V17.7636C13.8164 17.7164 14.8348 17.5693 15.7777 17.3384L18.4697 20.0303C19.8232 19.7374 19.8232 19.2626 19.5303 18.9697L17.3938 16.8331C20.0196 15.816 21.75 14.0773 21.75 12.1034C21.75 9.97178 19.7322 7.95444 16.748 6.96875C16.7493 7.01411 16.7499 7.05963 16.7499 7.1053C16.7499 7.31546 16.7368 7.5225 16.7115 7.72562C16.4136 10.1152 13.1874 10.7482 11.9999 10.7482C10.8124 10.7482 7.58615 10.1152 7.28826 7.72562C7.26294 7.5225 7.24989 7.31546 7.24989 7.1053Z" fill="currentColor" fillOpacity="0.25"></path>
                                    </svg>
                                    </figure>
                                
                                    <div className="sm:ml-4">
                                        <h6 className="text-lg font-bold text-white">Client-Centric Approach</h6>
                                        <p className="pb-0 text-[#c4c5c7]">Our client-centric approach ensures that we understand your unique needs and provide tailored solutions that exceed expectations.</p>
                                    </div>
                                </div>
